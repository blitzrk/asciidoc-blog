...
function extract(file) {
  ...
  var sectioned = contents.includes("==");
  var description = contents.substring(
    contents.indexOf("\n\n") + 2,
    sectioned ? contents.indexOf("==") : contents.length);
...
module.exports.scripts = function(blogroot, cb) {
  var scripts = [];
  var walker = walk.walk(blogroot+"/_assets/static/js");
...
module.exports.posts = function(blogroot, cb) {
  var files = [];
  var walker = walk.walk(blogroot+"/_posts");
