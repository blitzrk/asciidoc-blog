...
function render(config, content, scripts, posts) {
  var generated;
  var html = Array.isArray(content) ?
    content.filter(function(node) { return node.tagName === 'html' }) :
    content;
  if(html.length) {
...
module.exports = function(config) {
  return through.obj(function(file, enc, cb) {
    ...
    assets.scripts(config._blogroot, function(err, scripts) {
